...
public class StudentInfoServiceImpl implements StudentInfoService {
    ...
    @Override
    public Integer modifyStudentInfo(Long stuUniCode, String name, Date stuBirthDate, Integer sex, String address, Integer political, Date stuGraduationDate, Long telephone) {

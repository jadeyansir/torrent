...
public class ProfessionalSkillsDAO {
    ...
    public Integer deleteProfessionalSkills(ProfessionalSkillsDO professionalSkillsDO){
        return professionalSkillsMapper.deleteProfessionalSkills(professionalSkillsDO);
    }
}
